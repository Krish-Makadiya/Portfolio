...
const CarouselControl = ({ type, title, handleClick }) => {
    return (
        <button
            className={`w-10 h-10 flex items-center relative z-50 mx-2 justify-center bg-[#affc41] border-3 border-transparent rounded-full focus:border-[#affc41] focus:outline-none hover:-translate-y-0.5 active:translate-y-0.5 transition duration-200 ${
